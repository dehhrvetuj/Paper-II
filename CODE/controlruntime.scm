...
;; (ti-menu-load-string  "/solve/execute-commands add-edit control-run-time 1 \"time-step\"  \"/file/read-macros controlruntime.scm\"  ")
;;
...
;; (ti-menu-load-string "/define/boundary-conditions outlet-vent or_outlet , , -20 , , , , , , , , , , , , , 25")
;;
...
;;
(ti-menu-load-string "file/auto-save/data-frequency 100")
;;
;;
;;
;;
