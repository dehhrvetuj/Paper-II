...
(cond
	((eq? close #t)
        (begin
		    ...
		    (ti-menu-load-string 
		    	(format #f "/define/boundary-conditions/wall xdoor-d~02d , , , , yes heat-flux , , , , , yes trap , , , , , , , ," (- 51 doornum) ) 
		    )	
		    (ti-menu-load-string "\n")
		    
		    (ti-menu-load-string 
		    	(format #f "/define/boundary-conditions/wall xdoor-d~02d-shadow , , , , yes heat-flux , , , , , yes trap , , , , , , , ," (- 51 doornum) )
		    )
		    (ti-menu-load-string "\n")
        )
	)	
